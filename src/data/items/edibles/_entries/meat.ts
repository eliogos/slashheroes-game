...
import { defineEdible, defineVariant, EDIBLE_SUBTYPE, SATIATION_TYPE } from '../helpers/index.js';
...
const meat = defineEdible({
	...
	energy: Energy.FromKilocalories(250).Kilocalories,
...
export const cooked_meat = defineVariant(meat, {
	...
	energy: Energy.FromKilocalories(400).Kilocalories,
...
export const honeyed_steak = defineVariant(meat, {
	...
	rarity: 'uncommon',
	stackable: 3,
	energy: Energy.FromKilocalories(520).Kilocalories,
...
export const rotten_meat = defineVariant(meat, {
	...
	energy: Energy.FromKilocalories(-120).Kilocalories,
	satiationType: SATIATION_TYPE.INSTANT,
	form: 'rotten',
	decay: 0,
