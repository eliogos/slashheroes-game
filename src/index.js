...
export default {
  async fetch(request, env, ctx) {
    ...
    // For debugging with `wrangler tail`, log the full raw request body.
    // Be careful: this may contain sensitive data; enable only when needed.
    try {
      console.log('Raw request body for debugging:', bodyText);
    } catch (e) {
      console.warn('Failed to log raw request body', e);
    }
